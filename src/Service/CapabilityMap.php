...
class CapabilityMap
{
    ...
    private const MODULE_MAP = [
        ...
        // Product
        'pr-f-1' => 'product-thinking',
        'pr-f-2' => 'discovery',
        'pr-i-1' => 'product-strategy',
        'pr-i-2' => 'discovery',
        'pr-i-3' => 'product-thinking',
        'pr-a-1' => 'product-strategy',
        'pr-a-2' => 'delivery',
        'pr-e-1' => 'product-strategy',
        'ppm-f-1' => 'product-strategy',
        'ppm-f-2' => 'product-thinking',
        'ppm-f-3' => 'discovery',
        'ppm-f-4' => 'product-thinking',
        'ppm-i-1' => 'product-strategy',
        'ppm-i-2' => 'product-strategy',
        'ppm-i-3' => 'product-thinking',
        'ppm-i-4' => 'discovery',
        'ppm-i-5' => 'delivery',
        'ppm-i-6' => 'discovery',
        'ppm-a-1' => 'delivery',
        'ppm-a-2' => 'discovery',
        'ppm-a-3' => 'product-thinking',
        'ppm-a-4' => 'delivery',
        'ppm-a-5' => 'product-strategy',
        'ppm-e-1' => 'delivery',
        'ppm-e-2' => 'delivery',
        'ppm-e-3' => 'delivery',

        // Agile
        'ag-f-1' => 'agile-foundations',
        'ag-f-2' => 'agile-foundations',
        'ag-i-1' => 'workflow-improvement',
        'ag-i-3' => 'facilitation',
        'ag-a-2' => 'scaling',
        'ag-e-1' => 'coaching',
        'sm-f-1' => 'coaching',
        'sm-f-2' => 'coaching',
        'sm-f-3' => 'agile-foundations',
        'sm-f-4' => 'agile-foundations',
        'sm-f-5' => 'facilitation',
        'sm-f-6' => 'facilitation',
        'sm-i-1' => 'facilitation',
        'sm-i-2' => 'agile-foundations',
        'sm-i-3' => 'workflow-improvement',
        'sm-i-4' => 'workflow-improvement',
        'sm-i-5' => 'coaching',
        'sm-a-1' => 'scaling',
        'sm-a-2' => 'scaling',
        'sm-a-3' => 'scaling',
        'sm-a-4' => 'workflow-improvement',
        'sm-a-6' => 'scaling',
        'sm-e-1' => 'coaching',
        'sm-e-2' => 'coaching',
        'sm-e-3' => 'scaling',
        'sm-e-4' => 'workflow-improvement',

        // Agile — scrum.org classes
        ...
        // Cloud
        'cl-f-1' => 'cloud-foundations',
        'cl-f-2' => 'cloud-foundations',
        'cl-i-1' => 'architecture',
        'cl-i-2' => 'security-strategy',
        'cl-a-1' => 'architecture',
        'cl-a-2' => 'architecture',
        'cl-e-1' => 'security-strategy',

        // Leadership
        'ld-f-1' => 'people-teams',
        'ld-f-2' => 'people-teams',
        'ld-i-1' => 'influence-decision',
        'ld-i-2' => 'influence-decision',
        'ld-a-1' => 'strategy-change',
        'ld-a-2' => 'strategy-change',
        'ld-e-1' => 'strategy-change',
    ];
