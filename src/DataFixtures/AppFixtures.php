...
class AppFixtures extends Fixture
{
    ...
    {
        $data = [
            ['foundation',   'Foundation',   1, '#B75EB8', '#FBF5FB', 'Understands the basics and can take part with guidance.'],
            ['practitioner', 'Practitioner', 2, '#9A3C9B', '#F8EFF8', 'Applies the skill in everyday situations, with some support.'],
            ['professional', 'Professional', 3, '#7C1B7B', '#F4EAF4', 'Works independently in varied, complex situations; analyses and judges.'],
    ...
    private function createModules(ObjectManager $manager, array $levels, array $cats, array $roles, array $types, array $skills = []): void
    {
        ...
        $modules = [
            /* ===== AI ===== */
            ['ai-f-1','ai','foundation','What AI Really Is',$ALL,
            ...
            ['ai-f-2','ai','foundation','Data Literacy Basics',$ALL,
            ...
            ['ai-f-3','ai','foundation','AI Use Cases & Terminology',$NONTECH,
            ...
            ['ai-f-4','ai','foundation','Python for AI',['dev'],
            ...
            ['ai-f-5','ai','foundation','ML Environment Setup',['dev'],
            ...
            ['ai-f-6','ai','foundation','Designing for AI: A Primer',['ux'],
            ...
            ['ai-i-1','ai','practitioner','Writing AI Product Requirements',['pm','po'],
            ...
            ['ai-i-2','ai','practitioner','Defining AI Success Metrics',['pm','po'],
            ...
            ['ai-i-3','ai','practitioner','AI Risk Management',['pjm'],
            ...
            ['ai-i-4','ai','practitioner','Vendor & Tooling Evaluation',['pjm','ba'],
            ...
            ['ai-i-5','ai','practitioner','Data Pipelines for ML',['dev'],
            ...
            ['ai-i-6','ai','practitioner','Working with AI APIs',['dev'],
            ...
            ['ai-i-7','ai','practitioner','Specifying AI Data Requirements',['ba'],
            ...
            ['ai-i-8','ai','practitioner','Prototyping AI Interactions',['ux'],
            ...
            ['ai-a-1','ai','professional','Retrieval-Augmented Generation',['dev','pm'],
            ...
            ['ai-a-2','ai','professional','LLMOps Fundamentals',['dev'],
            ...
            ['ai-a-3','ai','professional','AI Governance & Compliance',['pjm','po','ba'],
            ...
            ['ai-a-4','ai','professional','Agentic Systems Design',['dev','pm'],
            ...
            ['ai-a-5','ai','professional','AI UX Research',['ux','pm'],
            ...
            /* ===== Product ===== */
            ['pr-f-1','product','foundation','Product Thinking Fundamentals',$ALL,
            ...
            ['pr-f-2','product','foundation','Discovery vs Delivery',$ALL,
            ...
            ['pr-i-1','product','practitioner','Outcome-Based Roadmapping',['pm','po'],
            ...
            ['pr-i-2','product','practitioner','Customer Interviewing',['pm','po','ux','ba'],
            ...
            ['pr-i-3','product','practitioner','Prioritisation Frameworks',['pm','po','pjm'],
            ...
            ['pr-a-1','product','professional','Product Strategy & Vision',['pm','po'],
            ...
            ['pr-a-2','product','professional','Experimentation & A/B Testing',['pm','dev'],
            ...
            /* ===== Agile ===== */
            ['ag-f-1','agile','foundation','Agile Mindset & Values',$ALL,
            ...
            ['ag-f-2','agile','foundation','Scrum in Practice',$ALL,
            ...
            ['ag-i-1','agile','practitioner','Backlog Refinement',['po','pm'],
            ...
            ['ag-i-2','agile','practitioner','Facilitating Agile Ceremonies',['pjm'],
            ...
            ['ag-i-3','agile','practitioner','User Story Mapping',['pm','po','ux'],
            ...
            ['ag-a-1','agile','professional','Scaling Agile (SAFe / LeSS)',['pjm','pm'],
            ...
            ['ag-a-2','agile','professional','Agile Metrics & Flow',['pm','pjm'],
            ...
            /* ===== Scrum Master (Agile) ===== */
            ['sm-f-1','agile','foundation','Foster Psychological Safety',['sm','po','pjm'],
            ...
            ['sm-f-2','agile','foundation','Give and Receive Feedback',['sm','po','pjm'],
            ...
            ['sm-f-3','agile','foundation','Teach Agile Values & Principles',['sm','pjm','pm'],
            ...
            ['sm-f-4','agile','foundation','Teach Scrum Foundations',['sm','po','dev'],
            ...
            ['sm-f-5','agile','foundation','Ask Powerful Questions',['sm','pjm','pm'],
            ...
            ['sm-f-6','agile','foundation','Design Playful Learning Experiences',['sm','pjm'],
            ...
            ['sm-i-1','agile','practitioner','Facilitate Scrum Events',['sm','po'],
            ...
            ['sm-i-2','agile','practitioner','Bring Scrum Values to Life',['sm','po','dev'],
            ...
            ['sm-i-3','agile','practitioner','Manage Visualise and Measure Workflow with Kanban',['sm','dev','po'],
            ...
            ['sm-i-4','agile','practitioner','Apply Evidence-Based Management',['sm','pm','po'],
            ...
            ['sm-i-5','agile','practitioner','Navigate Conflict Constructively',['sm','pjm','pm'],
            ...
            ['sm-a-1','agile','professional','Enable Self-Management and Collaborative Development',['sm','dev','po'],
            ...
            ['sm-a-2','agile','professional','Set Goals with OKRs',['sm','pm','po'],
            ...
            ['sm-a-3','agile','professional','Engage Stakeholders Strategically',['sm','pjm','pm'],
            ...
            ['sm-a-4','agile','professional','Manage Technical Debt & Define Done',['sm','dev'],
            ...
            ['sm-a-5','agile','professional','Facilitate Agile Events at Scale',['sm','pjm'],
            ...
            ['sm-a-6','agile','professional','Navigate Agile at Scale',['sm','pjm','pm'],
            ...
            ['ppm-f-1','product','foundation','Craft a Compelling Product Vision',['pm','po'],
            ...
            ['ppm-f-2','product','foundation','Tell Your Product Story',['pm','po','ba'],
            ...
            ['ppm-f-3','product','foundation','Build Customer and User Empathy',['pm','po','ux','ba'],
            ...
            ['ppm-f-4','product','foundation','Prioritise and Manage Requirements',['pm','po','ba'],
            ...
            ['ppm-i-1','product','practitioner','Define Product Strategy',['pm','po'],
            ...
            ['ppm-i-2','product','practitioner','Create Outcome-Driven Roadmaps',['pm','po','pjm'],
            ...
            ['ppm-i-3','product','practitioner','Engage Influence and Navigate Stakeholder Politics',['pm','po','pjm'],
            ...
            ['ppm-i-4','product','practitioner','Run Product Discovery and Design Thinking',['pm','po','ux'],
            ...
            ['ppm-i-5','product','practitioner','Measure Product Value and Apply Analytics',['pm','po','ba'],
            ...
            ['ppm-i-6','product','practitioner','Research Markets and Analyse Competitors',['pm','po','ba'],
            ...
            ['ppm-a-1','product','professional','Design and Run Product Experiments',['pm','po','dev'],
            ...
            ['ppm-a-2','product','professional','Design Inclusive and Engaging User Experiences',['ux','pm','po'],
            ...
            ['ppm-a-3','product','professional','Navigate Product Finances Budgeting and Pricing',['pm','pjm'],
            ...
            ['ppm-a-4','product','professional','Plan and Execute a Product Launch',['pm','po'],
            ...
            ['ppm-a-5','product','professional','Manage a Product Portfolio at Scale',['pm','pjm'],
            ...
            /* ===== Cloud ===== */
            ['cl-f-1','cloud','foundation','Cloud Fundamentals',$ALL,
            ...
            ['cl-f-2','cloud','foundation','Cloud Cost Awareness',['pm','pjm','ba'],
            ...
            ['cl-i-1','cloud','practitioner','Cloud Architecture Patterns',['dev'],
            ...
            ['cl-i-2','cloud','practitioner','Cloud Security Essentials',['dev','pjm'],
            ...
            ['cl-a-1','cloud','professional','Infrastructure as Code',['dev'],
            ...
            ['cl-a-2','cloud','professional','Kubernetes in Production',['dev'],
            ...
            /* ===== Leadership ===== */
            ['ld-f-1','leadership','foundation','Leading Digital Teams',$ALL,
            ...
            ['ld-f-2','leadership','foundation','Coaching Conversations',$ALL,
            ...
            ['ld-i-1','leadership','practitioner','Stakeholder Management',['pm','pjm','po'],
            ...
            ['ld-i-2','leadership','practitioner','Decision-Making Under Uncertainty',$ALL,
            ...
            ['ld-a-1','leadership','professional','Org Design for Digital',['pjm','pm'],
            ...
            ['ld-a-2','leadership','professional','Change Leadership',['pjm','pm','po'],
    ...
    private function createSkills(ObjectManager $manager, array $cats): array
    {
        ...
        foreach ($skills as $pos => [$slug, $name, $ring, $domain, $capKey, $view, $descs]) {
            ...
            $skill = (new Skill())
                ...
                ->setDescriptions([
                    'foundation'   => $descs[0],
                    'practitioner' => $descs[1],
                    'professional' => $descs[2],
                    'expert'       => $descs[3],
                ]);
